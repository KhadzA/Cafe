            ...
            <div class="header_inner">
                ...
                <div class="top_left">
                    <section>
                        ...
                        <li class="title_section">Menu</li>
                    </section>
                </div>
            </div>
        </div>
        ...
        <nav class="side_nav minimized">
            <div class="top_items">
                ...
                <section class="menu-items">
                    <li id="cashier" class="cashier"><i class="fa-solid fa-clipboard-list"></i> <span>Menu</span></li>
                    <li id="order" class="order"><i class="fas fa-th-list"></i> <span>Orders</span></li>
